...
enum {
	...
	SABI_OBJECT_DEVICE       = 0x0003,
	SABI_OBJECT_EVENT        = 0x0004,
	SABI_OBJECT_FIELD        = 0x0005,
	SABI_OBJECT_INDEX_FIELD  = 0x0006,
	SABI_OBJECT_BANK_FIELD   = 0x0007,
	SABI_OBJECT_METHOD       = 0x0008,
	SABI_OBJECT_MUTEX        = 0x0009,
	SABI_OBJECT_NAME         = 0x000A,
	SABI_OBJECT_OP_REGION    = 0x000B,
	SABI_OBJECT_POWER_RES    = 0x000C,
	SABI_OBJECT_PROCESSOR    = 0x000D,
	SABI_OBJECT_SCOPE        = 0x000E,
	SABI_OBJECT_THERMAL_ZONE = 0x000F,
};
